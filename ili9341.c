...
void sendData16(uint16_t data)
{
	...
	DC_OFF;
	SPI_Sercom5_send(data1);
	SPI_Sercom5_send(data2);
}
...
/*aletrnatywa funkcji putInteger, mniej zasobw pamieci*/
...
/*aletrnatywa funkcji putFloat, mniej zasobw pamieci*/
//unsigned char putFloat(float floatNumber, unsigned int x0, unsigned int y0, unsigned int size, unsigned int fgcolor)
//{
