...
*/
/*atomwe zapisy do rejestru OUT*/
#define DC_ON		(PORT->Group[0].OUTCLR.reg = PORT_PA24);//set 0 PA24
#define DC_OFF	(PORT->Group[0].OUTSET.reg = PORT_PA24);//set 1 PA24
#define RESET_ON 	(PORT->Group[0].OUTCLR.reg = PORT_PA25);//set 0 PA25
#define RESET_OFF 	(PORT->Group[0].OUTSET.reg = PORT_PA25);//set 1 PA25 

/*alternatywny zapis do rejestru OUT bez użycia "atomistyki"*/
//#define DC_ON		(PORT->Group[0].OUT.reg &= ~PORT_PA24);//set 0 PA24
//#define DC_OFF	(PORT->Group[0].OUT.reg |= PORT_PA24);//set 1 PA24
//#define RESET_ON 	(PORT->Group[0].OUT.reg &= ~PORT_PA25);//set 0 PA25
//#define RESET_OFF 	(PORT->Group[0].OUT.reg |= PORT_PA25);//set 1 PA25 
